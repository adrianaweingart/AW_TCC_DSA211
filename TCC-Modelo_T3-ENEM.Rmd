---
title: "TCC - Modelo T3 (Análise de Agrupamentos e ACM) - ENEM"
...
ENEM <- read_delim("MICRODADOS_ENEM_2020.csv", delim = ";")
```
...
write.csv(TOTAL_DL, "A1 (1) - T3 - Tempo Data Loading.csv")
```
...
write.csv(TOTAL_DW, "A1 (1) - T3 - Tempo Data Wrangling.csv")
```
...
write.csv(TOTAL_AC, "A1 (1) - T3 - Tempo Análise de Cluster.csv")
```
...
write.csv(TOTAL_ACM, "A1 (1) - T3 - Tempo ACM.csv")
```
...
write.csv(TOTAL, "A1 (1) - T3 - Tempo TOTAL.csv")
```
