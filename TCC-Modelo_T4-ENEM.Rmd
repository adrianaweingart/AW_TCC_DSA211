---
title: "TCC - Modelo T4 (Análise Fatorial) - ENEM"
...
write.csv(TOTAL_DL, "A1 (1) - T4 - Tempo Data Loading.csv")
```
...
write.csv(TOTAL_DW, "A1 (1) - T4 - Tempo Data Wrangling.csv")
```
...
write.csv(TOTAL_AF, "A1 (1) - T4 - Tempo Análise Fatorial.csv")
```
...
write.csv(TOTAL, "A1 (1) - T4 - Tempo TOTAL.csv")
```
